...
def start_game(event):
    ...
    if playing is False:
        ...
        canvas.delete("all")
        BALL_COLOR = ["red", "yellow", "lightgreen"]
        BRICK_COLOR = ["deeppink","red","orange","yellow","lightgreen","cyan","royalblue","magenta","aquamarine"]
...
canvas.create_text(250, 425, text="Press Enter to start Game!!", fill="red", font="Consolas 18")
root.mainloop()
